...
####FrenchGuiana
```{r}
avg_proportions_SA_toAfrica <- avg_proportions_noSelf[!(avg_proportions_noSelf$Country %in% c('FrenchGuiana','Colombia','Peru','Venezuela')),]
avg_proportions_SA_toAfrica 
gg <- ggplot(avg_proportions_SA_toAfrica[avg_proportions_SA_toAfrica$Origin=='FrenchGuiana',], aes(x=Isolate, y=reWeighted, fill=Country))
gg <- gg + facet_grid(~Country)
gg <- gg + coord_cartesian(ylim=c(0,0.025))
gg <- gg + geom_bar(stat = "identity")
gg <- gg + theme_bw() + theme(axis.text.x = element_text(angle = 90))
gg
```
...
avg_proportions_SA_toAfrica <- avg_proportions_noSelf[!(avg_proportions_noSelf$Country %in% c('FrenchGuiana','Colombia','Peru','Venezuela')),]
avg_proportions_SA_toAfrica 
gg <- ggplot(avg_proportions_SA_toAfrica[avg_proportions_SA_toAfrica$Origin=='Peru',], aes(x=Isolate, y=reWeighted, fill=Country))
gg <- gg + facet_grid(~Country)
gg <- gg + coord_cartesian(ylim=c(0,0.025))
gg <- gg + geom_bar(stat = "identity")
gg <- gg + theme_bw() + theme(axis.text.x = element_text(angle = 90))
...
avg_proportions_SA_toAfrica <- avg_proportions_noSelf[!(avg_proportions_noSelf$Country %in% c('FrenchGuiana','Colombia','Peru','Venezuela')),]
avg_proportions_SA_toAfrica 
gg <- ggplot(avg_proportions_SA_toAfrica[avg_proportions_SA_toAfrica$Origin=='Colombia',], aes(x=Isolate, y=reWeighted, fill=Country))
gg <- gg + facet_grid(~Country)
gg <- gg + coord_cartesian(ylim=c(0,0.015))
gg <- gg + geom_bar(stat = "identity")
gg <- gg + theme_bw() + theme(axis.text.x = element_text(angle = 90))
gg
```
...
avg_proportions_SA_toAfrica <- avg_proportions_noSelf[!(avg_proportions_noSelf$Country %in% c('FrenchGuiana','Colombia','Peru','Venezuela')),]
avg_proportions_SA_toAfrica 
gg <- ggplot(avg_proportions_SA_toAfrica[avg_proportions_SA_toAfrica$Origin=='Venezuela',], aes(x=Isolate, y=reWeighted, fill=Country))
gg <- gg + facet_grid(~Country)
gg <- gg + coord_cartesian(ylim=c(0,0.025))
gg <- gg + geom_bar(stat = "identity")
gg <- gg + theme_bw() + theme(axis.text.x = element_text(angle = 90))
