...
inputfile = "./mosaic_data/combined_454_tessema_renamed.fasta"
...
97.14% of the sequences were successfully translated. We would now like to filter out those that did not translate along with the labratory isolates before clustering the remaining sequences.
...
with open("./mosaic_data/DNA_NoLab_translateable_combined_454_tessema.fasta", 'w') as outfile:
  for h,s in FastaReader("./mosaic_data/combined_454_tessema_renamed.fasta"):
    if h in keep:
      outfile.write(">"+h+"\n"+s+"\n") 
```
