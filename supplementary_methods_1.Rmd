...
rownames(majorTypeMatrix) <- paste(annotation_row$shortID, annotation_df$Countries, sep="-")
...
# Specify colors
ann_colors = list(
    Country = c(Peru="#a6cee3", Gabon="#1f78b4", Colombia="#b2df8a",
                FrenchGuiana="#33a02c", Iran="#fb9a99",
                Thailand="#e31a1c", Ghana="#fdbf6f", PNG="#ff7f00",
