...
ann_colors = list(
    ...
    Annotation = c(none = "#66c2a5", pseudo = "#8da0cb"
                   , pseudo_var1csa = "#fc8d62", pseudo_var3="#e78ac3"
                   , var5="#a6d854")
)
pheatmap(majorTypeMatrix, cluster_cols = FALSE
